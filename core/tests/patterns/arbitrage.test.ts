...
import type {
    ArbitrageConfig,
    DEX,
} from "../../src/patterns/ai-agents/arbitrage";
...
describe("ArbitragePattern", () => {
    ...
    describe("Opportunity Detection", () => {
        it("should scan for arbitrage opportunities", async () => {
            ...
            expect(result.success).toBe(true);
            expect(result.metadata?.opportunitiesFound).toBeGreaterThanOrEqual(
                0
            );
        });
    ...
    describe("Execution", () => {
        ...
        it("should include metadata in result", async () => {
            ...
            expect(
                result.metadata?.opportunitiesExecuted
        ...
        it("should calculate average profit percent", async () => {
            ...
            expect(
                result.metadata?.averageProfitPercent
            ).toBeGreaterThanOrEqual(0);
        });
    });
    ...
    describe("Parallel Execution", () => {
        it("should optimize transactions for parallel execution", async () => {
            ...
            if (
                result.metadata?.opportunitiesExecuted &&
                result.metadata.opportunitiesExecuted > 0
            ) {
